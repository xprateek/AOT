 ...
 * Setup Header Menu
 */
const menuBtn = document.getElementById('usage-menu-button');
...
document.getElementById('source-code')?.addEventListener('click', () => {
    exec('am start -a android.intent.action.VIEW -d "https://github.com/xprateek/AOT-Tether"');
});

document.getElementById('developer-credit')?.addEventListener('click', () => {
    exec('am start -a android.intent.action.VIEW -d "https://t.me/xprateek"');
});
