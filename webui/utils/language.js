...
async function detectUserLanguage() {
    ...
    try {
        ...
        const prefered_language_code = localStorage.getItem('aotLanguage');
        ...
        if (prefered_language_code !== 'default' && availableLanguages.includes(prefered_language_code)) {
            ...
            localStorage.removeItem('aotLanguage');
            return 'en';
        }
    } catch (error) {
...
function setLanguage(language) {
    localStorage.setItem('aotLanguage', language);
...
async function generateLanguageMenu() {
    ...
    const createOption = (lang, name) => {
        ...
        const currentLang = localStorage.getItem('aotLanguage') || 'default';
        if (currentLang === lang) {
            radio.checked = true;
        }
