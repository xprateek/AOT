...
import logsHtml from './page/logs/logs.html?raw';
import settingsHtml from './page/settings/settings.html?raw';

import * as homeModule from './page/home/home.js';
import * as logsModule from './page/logs/logs.js';
import * as settingsModule from './page/settings/settings.js';
...
class Router {
    constructor() {
        ...
        this.registry = {
            ...
            logs: { html: logsHtml, module: logsModule },
            settings: { html: settingsHtml, module: settingsModule }
        };
    }

    /**
     * Navigate to a page
     * @param {string} name - Page name (e.g., 'home')
     */
    navigate(name) {
